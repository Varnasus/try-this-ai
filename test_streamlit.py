...
"""
    ...
    def test_06_generate_button_with_valid_inputs(self):
        ...
        with patch('streamlit.button', return_value=True) as mock_button, \
             patch('pipeline.text_to_speech.run_tts', mock_tts), \
             patch('pipeline.make_video.render_video', mock_render), \
             patch('streamlit.success', mock_success):
            ...
            if mock_button("Generate Video"):
                ...
                mock_tts.assert_called_once_with(
                    self.test_script,
                    str(self.test_dir / "audio" / "test.mp3")
                )
    ...
    def test_07_preview_button(self):
        ...
        with patch('streamlit.button', return_value=True) as mock_button, \
             patch('streamlit.markdown', mock_markdown):
